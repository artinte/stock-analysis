...
AllCompanyInfos = {
    ...
    CompanyInfo(
        ...
        exchange="SSE",
        country="China",
        market_cap=205.80,  # 截至2026-03-13收盘，总市值205.8亿人民币
        last_price=16.55,  # 2026-03-13收盘价
        sector="有色金属 / 铝加工",
        industry="铝板带箔 / 再生铝循环",
        pe_ratio=6.74,  # 基于2026年预期30.5亿归母净利润计算的前瞻PE
        dividend_yield=4.3,  # 基于预期30%分红率及16.55元股价估算
        ...
        websites={"official": "http://www.mingtai-al.com"},
        analysis=[
