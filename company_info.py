...
AllCompanyInfos = {
    ...
    CompanyInfo(
        ...
        exchange="SSE (上交所)",
        country="China",
        market_cap=96.36,  # 亿人民币 (2026年6月下旬估值，基于近期 18.50 元左右波动)
        last_price=18.46,  # 2026年6月下旬参考价
        sector="工业 / 机械制造 / 高端装备",
        industry="数控机床 / 五轴加工中心 / 龙门加工中心 / 核心零部件国产化",
        pe_ratio=21.83,  # TTM 估值，作为民营高端机床龙头，享有一定的自主可控与出海估值溢价
        ps_ratio=2.85,  # 相对合理的市销率，反映了高壁垒民营制造业的毛利水平与稳定营收
        dividend_yield=1.63,  # 基于近期派息方案与股价测算，分红政策整体保持连续与稳定
        description="海天精工是中国高端数控机床领域的民营排头兵，依托海天集团强大的制造基因，深耕中高端数控机床研发与生产。\
    公司在龙门加工中心、卧式加工中心、立式加工中心等领域具备极强的市场竞争力，是国内少有的能直接在高精尖领域与台系、日系机床切磋的本土厂商。\
    近年来，公司紧跟“工业母机”国产替代浪潮，在汽车零部件、新能源、航空航天及模具制造等高门槛行业实现大面积份额渗透。\
    通过“大客户定制化开发 + 敏捷供应链管理”的双轮驱动，海天精工不仅在国内中高端龙门市场长期霸榜，更积极布局海外市场，\
    在华东、华南等核心工业重镇及海外出口建立起极高的品牌壁垒，成长为国内工业母机领域兼具技术硬实力与商业化落地能力的‘效率型’龙头。",
        tags=[
            "民营高端数控机床领头羊 (龙门加工中心市占率领先)",
            "工业母机国产替代核心标的 (新能源汽车与航空航天产业链验证)",
            "海外出口海外市场第二增长曲线 (海外渠道布局进入收获期)",
            "高资产周转率与精细化运营典范 (盈利能力显著高于行业均值)",
            "高端五轴加工中心技术突破者",
            "中证 A500 / 机械设备板块重要成分股",
        ],
        competitors=[
            "纽威数控 (688697) - 国内民营中高端数控机床的直接竞争对手",
            "创世纪 (300083) - 3C与轻量化立加领域的行业大厂，在部分通用领域存在竞争",
            "国盛智科 (688558) - 同属华东精细化制造、布局数控机床与装备部件的同行",
            "大隈 (Okuma) / 牧野 (Makino) - 在航空航天及高端模具市场的海外技术标杆与竞争对手",
        ],
        websites={"official": "http://www.haitianprecision.com/"},
        analysis=[
            "优点：下游结构转型顺畅。新能源汽车、航天航空及海外出口的强劲需求，有效对冲了传统通用机械周期的波动，驱动利润保持韧性增长。",
            "优点：精细化管理与规模效应。得益于海天集团集中采购与标准化零部件开发，管理费用率与核心部件自制率行业领先，净利率长期维持在 12% 以上的高位。",
            "优点：出海进程提速。海外市场毛利率普遍高于国内，随着海外销售网络铺开，出口占比提升将持续优化公司的整体毛利结构。",
            "缺点：宏观周期制造业资本开支承压。数控机床作为典型的资本品，若下游通用制造业复苏不及预期，新设备采购需求可能面临阶段性放缓。",
            "缺点：高端核心部件依赖。虽然结构件与组装完全自主，但部分超高端机床的数控系统、高精度主轴及轴承仍需依赖外资品牌（如发那科、西门子），供应链完全自主化仍需时间。",
            "缺点：估值处于成长溢价区。20x+ 的 PE 相比传统重资产机械股偏高，市场对其工业母机属性给予了溢价，后续需要产能释放与海外大单持续兑现来消化估值。",
        ],
        product_lines=[
            "龙门加工中心：压舱石。主要应用于大型模具、汽车核心部件及航空航天结构件，技术成熟度与市占率国内名列前茅，贡献稳定营收。",
            "立式/卧式加工中心：增长主力。主打高刚性、高效率通用加工，受益于新能源汽车三电系统及轻量化底盘件的爆发，正处于快速放量阶段。",
            "五轴及精密机床：未来之星。聚焦高端复杂曲面加工，攻关“卡脖子”领域，是公司未来提升客单价、切入纯高端军工/航天市场的核心重构动力。",
        ],
    ),
}
