...
* 股票预测：需要预测的内容有很多，比如指数的涨跌，K线走势等详细信息。
...
运行本数据库有几个难点，一个是券商数据，一个是AI训练。为了方便不同类型的人需求，将系统拆分成不同的独立模块，尽量每个模块既能够独立运行，又能够组装成一个完整的系统。想要快速了解本仓库，可以查看 quick_start.py 的代码，它是一个基本的 python 程序，已经准备好数据，同时不需要 AI 就能运行。
